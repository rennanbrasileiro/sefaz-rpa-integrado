...
function defaultState() {
  ...
  return {
    ...
    easymob: { marksToday: [], nextAction: null, plannedTime: null, lastExecution: null, lastError: null, routine: { enabled: false, dryRun: true, times: [], nextCheck: null, waitingUntil: null }, watchdog: { status: 'idle' } },
